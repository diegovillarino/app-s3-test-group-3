...
BUCKET_NAME = os.environ.get("TEST_GRUPO3_ACN_TEST_3_BUCKET_NAME", "")
BUCKET_REGION = os.environ.get("S3_BUCKET_V2_BUCKET_REGION", "us-east-1")
AWS_ACCESS_KEY_ID = os.environ.get("TEST_GRUPO3_ACN_TEST_3_ACCESS_KEY_ID", "")
AWS_SECRET_ACCESS_KEY = os.environ.get("TEST_GRUPO3_ACN_TEST_3_SECRET_ACCESS_KEY", "")
...
def health():
    return jsonify({
        ...
        "bucket_arn": os.environ.get("TEST_GRUPO3_ACN_TEST_3_BUCKET_ARN", ""),
